...
const Hero = ({ children, offset }) => (
  <>
    <Divider speed={0.2} offset={offset}>
      <UpDown>
        <SVG icon="hexa" hiddenMobile width={48} stroke={colors.orange} left="10%" top="20%" />
        <SVG icon="hexa" width={48} stroke={colors.red} left="60%" top="70%" />
        <SVG icon="hexa" width={6} fill={colors['grey-darker']} left="60%" top="15%" />
      </UpDown>
      <UpDownWide>
        <SVG icon="hexa" hiddenMobile width={16} fill={colors['blue-dark']} left="80%" top="10%" />
        ...
        <SVG icon="hexa" width={16} stroke={colors['pink-light']} left="28%" top="15%" />
      ...
      <SVG icon="hexa" width={64} fill={colors.green} left="95%" top="5%" />
      <SVG icon="hexa" hiddenMobile width={64} fill={colors.purple} left="5%" top="90%" />
